from modules.client_type import create_client_type, read_client_types, update_client_type, delete_client_type

def list_client_types():
    """Prints a list of all client types."""
    client_types = read_client_types()
    if not client_types:
...
def add_client_type():
    ...
    new_client_type = create_client_type(name)
...
def edit_client_type():
    ...
    updated_client_type = update_client_type(client_type_id, name)
    if updated_client_type:
        print(f"Tipo de cliente '{updated_client_type.name}' actualizado con éxito.")
    else:
...
def remove_client_type():
    ...
    if delete_client_type(client_type_id):
